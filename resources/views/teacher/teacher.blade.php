...
@section('content')
        ...
        <div class="widget-content widget-content-area blog-create-section">
            ...
            <a class="btn btn-primary mb-3 mt-3" href="{{route('teacher.create')}}">{{__('Add New Teacher')}}</a>
                ...
                <table class="table table-hover table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="text-success"> {{$teacher->specialization->name}} </span>
                        </td>
                        ...
                        <td class="text-center">
                            <span class=  {{ $teacher->gender->name == 'male' ? "text-success" : "text-danger" }} > {{$teacher->gender->name}} </span>
                        </td>
                        <td class="text-center">
                            <div class="action-btns">
                                ...
                                <a href=" {{route('teacher.edit',$teacher->id)}} " class="action-btn btn-edit bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="Edit">
