...
<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar" >
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="#teacher" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-dollar-sign"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>
                ...
                <ul class="collapse submenu list-unstyled" id="teacher" data-bs-parent="#accordionExample">
                    <li>
                        <a href="{{ url('/' . $page='teacher') }}">{{__('Teacher')}} </a>
                    </li>

                    <li>
                        <a href="{{ url('/' . $page='teacher/create') }}"> {{__('Add Teacher')}} </a>
                    </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="student" data-bs-parent="#accordionExample">
                    <li>
                        <a href="{{ url('/' . $page='student') }}">{{__('List Student')}} </a>
                    </li>

                    <li>
                        <a href="{{ url('/' . $page='student/create') }}"> {{__('Add Student')}} </a>
                    </li>
